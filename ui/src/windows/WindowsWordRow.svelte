...
<style>
  .word-row { width: 100%; min-height: 60px; display: grid; grid-template-columns: 32px minmax(140px, 1fr) 76px 210px 16px; gap: 12px; align-items: center; padding: 8px 14px; border: 0; border-bottom: 1px solid #30323d; color: #eeeef3; background: transparent; text-align: left; cursor: pointer; font: inherit; }
  .word-row:last-child { border-bottom: 0; }.word-row:hover { background: #272934; }.word-row:focus-visible { outline: 2px solid #9aa5ff; outline-offset: -2px; }
  ...
  .word { display: grid; gap: 3px; }.word small, .metadata { color: #9195a4; font-size: 11px; }
